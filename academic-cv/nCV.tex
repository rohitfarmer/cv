...
\begin{cvlist}{Key Scientific Skills}
	...
	\item[\textbf{Data Science and ML Tools:}] Tidyverse, lme4, NumPy, Pandas, SciPy, Matplotlib, Seaborn, Plotly, Scikit Learn, Keras, TensorFlow
...
\begin{cvlist}{Software Developed}
	\item {\begin{itemize}
			\item{\bf Stim Cell Selector}: An R package for the identification of responding cells in cytometry stimulation assays \url{https://niaid.github.io/stimcellselector/}.
                \end{itemize}}
\end{cvlist}
...
\item {\textit{Google Scholar: h-index 9, i10-index 7,} \url{http://bit.ly/rf_cite}}
\vskip3pt
